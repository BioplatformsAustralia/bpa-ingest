...
for funcname in BaseContextualMetadataApply BaseContextualMetadataSheet BPAMAdminCSVExport CKANCheckAllResourcesIntegrities CKANResourceIntegrityCheck SpreadsheetFunc; do
