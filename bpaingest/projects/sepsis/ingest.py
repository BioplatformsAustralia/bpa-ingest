        ...
        for fname in self.path.walk(filter=is_metadata):
            ...
            for row in rows:
                ...
                obj = {
                    ...
                    'id': name,
                    'bpa_id': bpa_id,
                    'notes': 'ARP Genomics Miseq Data: %s %s %s' % (track_meta.taxon_or_organism, track_meta.strain_or_isolate, track_meta.omics),
        ...
        for fname in self.path.walk(filter=is_metadata):
            ...
            for row in rows:
                ...
                obj = {
                    ...
                    'notes': 'ARP Genomics Pacbio Data: %s %s %s' % (track_meta.taxon_or_organism, track_meta.strain_or_isolate, track_meta.omics),
                    'insert_size_range': row.insert_size_range,
                    'library_construction_protocol': row.library_construction_protocol,
                    'sequencer': row.sequencer,
        ...
        for fname in self.path.walk(filter=is_metadata):
            ...
            for row in rows:
                ...
                obj = {
                    ...
                    'notes': 'ARP Transcriptomics Hiseq Data: %s %s %s' % (track_meta.taxon_or_organism, track_meta.strain_or_isolate, track_meta.omics),
                    'sample': row.sample,
                    'library_construction_protocol': row.library_construction_protocol,
