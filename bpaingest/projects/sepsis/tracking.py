...
class SepsisTrackMetadata:
    ...
    def get(self, sample_id):
        ...
        return {
            ...
            "archive_ingestion_date": getattr(
                track_meta, "archive_ingestion_date", None
            ),
        }
...
class SepsisGoogleTrackMetadata:
    ...
    def get_track_meta(self, track_rows):
        ...
        for ticket_id, meta_list in track_rows.items():
            track_meta[ticket_id] = common_values(
                [meta._asdict() for meta in meta_list]
            )
    ...
    def get(self, ticket):
        ...
        custom_obj_type = namedtuple(
            "SepsisGoogleDriveTrackCommonMeta", self.track_meta[ticket].keys()
        )
