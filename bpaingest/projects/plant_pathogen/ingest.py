...
from .contextual import (
    PlantPathogenLibraryContextual,
...
common_context = [PlantPathogenLibraryContextual, PlantPathogenDatasetControlContextual]
...
class PlantPathogenONTPromethionMetadata(PlantPathogenBaseMetadata):
    ckan_data_type = "pp-ont-promethion"
    ...
    metadata_patterns = [r"^.*\.md5$", r"^.*_metadata.*.*\.xlsx$"]
    metadata_urls = [
        "https://downloads-qcif.bioplatforms.com/bpa/pp_staging/ont-promethion/",
    ]
    metadata_url_components = ("ticket",)
    resource_linkage = (
        "ticket",
