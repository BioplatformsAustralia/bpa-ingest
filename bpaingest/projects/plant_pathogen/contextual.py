...
class PlantPathogenDatasetControlContextual(BaseDatasetControlContextual):
    metadata_urls = [
        "https://downloads-qcif.bioplatforms.com/bpa/pp_staging/dataset_control/2023-09-04/"
    ]
...
class PlantPathogenLibraryContextual(BaseLibraryContextual):
    metadata_urls = [
        "https://downloads-qcif.bioplatforms.com/bpa/pp_staging/metadata/2023-09-14/"
    ]
