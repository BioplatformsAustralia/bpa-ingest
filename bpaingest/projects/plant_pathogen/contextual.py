...
class PlantPathogenDatasetControlContextual(BaseDatasetControlContextual):
    metadata_urls = [
        "https://downloads-qcif.bioplatforms.com/bpa/pp_staging/dataset_control/2025-11-20/"
    ]
...
class PlantPathogenLibraryContextual(BaseLibraryContextual):
    metadata_urls = [
        "https://downloads-qcif.bioplatforms.com/bpa/pp_staging/metadata/2025-11-20/"
    ]
