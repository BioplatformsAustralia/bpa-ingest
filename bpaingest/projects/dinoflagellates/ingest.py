...
from . import files
from .contextual import DinoflagellatesLibraryContextual, DinoflagellatesDatasetControlContextual
from .tracking import DinoflagellatesGoogleTrackMetadata
...
common_context = [DinoflagellatesLibraryContextual, DinoflagellatesDatasetControlContextual]

CONSORTIUM_ORG_NAME = "dinoflagellates-consortium-members"


class DinoflagellatesBaseMetadata(BaseMetadata):
    initiative = "Dinoflagellate Genomics and Toxin Discovery"
    organization = "dinoflagellates"
    generaliser = None
    ...
    def __init__(self, logger, metadata_path, contextual_metadata=None, metadata_info=None):
        ...
        self.google_track_meta = DinoflagellatesGoogleTrackMetadata(logger)
...
class DinoflagellatesIlluminaShortreadMetadata(DinoflagellatesBaseMetadata):
    ckan_data_type = "alg-illumina-shortread"
    ...
    metadata_urls = [
        "https://downloads-qcif.bioplatforms.com/bpa/dinoflagellates/illumina-shortread/",
    ]
...
class DinoflagellatesONTPromethionMetadata(DinoflagellatesBaseMetadata):
        ckan_data_type = "alg-ont-promethion"
        ...
        metadata_patterns = [r"^.*\.md5$", r"^.*_metadata.*.*\.xlsx$"]
        metadata_urls = [
            "https://downloads-qcif.bioplatforms.com/bpa/dinoflagellates/ont-promethion/",
        ]
        metadata_url_components = ("ticket",)
