...
from . import files
from .contextual import AVIDLibraryContextual, AVIDDatasetControlContextual
from .tracking import AVIDGoogleTrackMetadata
...
CONSORTIUM_ORG_NAME = "aus-venom-consortium-members"


class AVIDBaseMetadata(BaseMetadata):
    initiative = "Australian Venom Innovation and Discovery"
    organization = "aus-venom"
    generaliser = None
...
class AVIDIlluminaShortreadMetadata(AVIDBaseMetadata):
    ckan_data_type = "avid-illumina-shortread"
    ...
    metadata_urls = [
        "https://downloads-qcif.bioplatforms.com/bpa/avid_staging/illumina-shortread/",
    ]
...
class AVIDPacbioHifiMetadata(AVIDBaseMetadata):
    ckan_data_type = "avid-pacbio-hifi"
    ...
    metadata_urls = [
        "https://downloads-qcif.bioplatforms.com/bpa/avid_staging/pacbio-hifi/",
    ]
    metadata_url_components = ("ticket",)
