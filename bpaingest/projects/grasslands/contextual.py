...
class AGLibraryContextual(BaseLibraryContextual):
    metadata_urls = [
        "https://downloads-qcif.bioplatforms.com/bpa/grasslands/metadata/2024-10-31/"
    ]
    ...
    field_spec = [
        ...
        fld(
            "id_vetting_date", "id_vetting_date", coerce=ingest_utils.get_date_isoformat
        ),
        ...
        fld(
            "sample_material_associated_references",
            "sample_material_associated_references",
        ),
        fld("sample_material_preparation_type", "sample_material_preparation_type"),
        fld(
            "sample_material_preparation_process", "sample_material_preparation_process"
        ),
