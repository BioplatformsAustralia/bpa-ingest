...
amplicon_control_filename_re = re.compile("""
    ^(?P<control_type>Arc_mock_community|Arch_mock_community|Bac_mock_community|Fungal_mock_community|Fungal-mock-community|Fungal__mock_Community|Soil_DNA|Soil-DNA||STAN|NEG1|NEG2|Neg|Neg1|Neg2|NEG|Undetermined)_
""", re.VERBOSE)
...
def test_amplicon_control():
    filenames = [
        ...
        'Undetermined_AGRF_A5K1H_S0_L001_R2.fastq.gz',
        'Undetermined_S0_L001_R1.fastq.gz',
    ]
