...
class AustralianMicrobiomeSampleContextual:
    ...
    field_specs = {
        sheet_name: [
            ...
            fld("but_fuco", "but_fuco", units="mg/m3", coerce=ingest_utils.get_clean_number),
            ...
            fld("cation_exchange_capacity", "cation_exchange_capacity", units="meq/100g", coerce=ingest_utils.get_clean_number),
            ...
            fld("course_sand", "course_sand", units="%", coerce=ingest_utils.get_clean_number),
            fld("course_sand_meth", "course_sand_meth"),
            fld(
                "cphlide_a", "cphlide_a", units="mg/m3", coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld("days_since_planting", "days_since_planting",units="days", coerce=ingest_utils.get_clean_number),
            fld(
                "density",
                "density",
                units="kg/m3",
            ...
            fld("dysprosium", "dysprosium", units="ppm", coerce=ingest_utils.get_clean_number),
            ...
            fld("europium", "europium", units="ppm", coerce=ingest_utils.get_clean_number),
            ...
            fld("fresh_weight", "fresh_weight", units="g", coerce=ingest_utils.get_clean_number),
            ...
            fld("gadolinium_meth", "gadolinium_meth", units="ppm", coerce=ingest_utils.get_clean_number),
            fld("gallium", "gallium",units="ppm", coerce=ingest_utils.get_clean_number),
            fld("gallium_meth", "gallium_meth"),
            fld("germanium", "germanium",units="ppm", coerce=ingest_utils.get_clean_number),
            ...
            fld("hafnium", "hafnium",units="ppm", coerce=ingest_utils.get_clean_number),
            ...
            fld("holmium", "holmium",units="ppm", coerce=ingest_utils.get_clean_number),
            ...
            fld("iridium", "iridium", units="ppm", coerce=ingest_utils.get_clean_number),
            ...
            fld("lanthanum", "lanthanum", units="ppm", coerce=ingest_utils.get_clean_number),
            ...
            fld("light_intensity", "light_intensity",units="lux", coerce=ingest_utils.get_clean_number),
            ...
            fld("lutetium", "lutetium", units="ppm", coerce=ingest_utils.get_clean_number),
            ...
            fld("magnesium", "magnesium", units="mg/l", coerce=ingest_utils.get_clean_number),
            ...
            fld("nitrate_nitrite", "nitrate_nitrite", units=u"\u00B5" + "mol/l",
                coerce=ingest_utils.get_clean_number,),
            ...
            fld("org_matter", "org_matter", units="%", coerce=ingest_utils.get_clean_number),
            ...
            fld("osmium", "osmium", units="ppm",
                coerce=ingest_utils.get_clean_number,),
            fld("osmium_meth", "osmium_meth"),
            fld(
                "oxygen", "oxygen",  units=u"\u00B5" + "mol/l", coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld("palladium", "palladium", units="ppm", coerce=ingest_utils.get_clean_number),
            fld("palladium_meth", "palladium_meth"),
            fld("pam_fluorometer", "pam_fluorometer", coerce=ingest_utils.get_clean_number),
            fld("pam_fluorometer_meth", "pam_fluorometer_meth"),
            fld("par", "par", units=u"\u00B5" + "mol/m^2/s^-1", coerce=ingest_utils.get_clean_number),
            ...
            fld("picoeukaryotes", "picoeukaryotes", units="cells/ml", coerce=ingest_utils.get_clean_number),
            ...
            fld("platinum", "platinum", units="ppm", coerce=ingest_utils.get_clean_number),
            ...
            fld("praseodymium", "praseodymium", units="ppm", coerce=ingest_utils.get_clean_number),
            fld("praseodymium_meth", "praseodymium_meth"),
            fld("pres_rel", "pres_rel", units="dbar", coerce=ingest_utils.get_clean_number),
            fld("pres_rel_meth", "pres_rel_meth"),
            fld("prochlorococcus", "prochlorococcus", units="cells_ml", coerce=ingest_utils.get_clean_number),
            ...
            fld("rhodium", "rhodium", units="ppm", coerce=ingest_utils.get_clean_number),
            fld("rhodium_meth", "rhodium_meth"),
            fld("root_length", "root_length", units="cm", coerce=ingest_utils.get_clean_number),
            fld("root_length_meth", "root_length_meth"),
            fld("rubidium", "rubidium", units="ppm", coerce=ingest_utils.get_clean_number),
            fld("rubidium_meth", "rubidium_meth"),
            fld("ruthenium", "ruthenium", units="ppm", coerce=ingest_utils.get_clean_number),
            fld("ruthenium_meth", "ruthenium_meth"),
            fld("salinity", "salinity", units="practical salinity unit", coerce=ingest_utils.get_clean_number),
            fld("salinity_meth", "salinity_meth"),
            fld("salinity_lab", "salinity_lab", units="practical salinity unit", coerce=ingest_utils.get_clean_number),
            fld("salinity_lab_meth", "salinity_lab_meth"),
            fld("samarium", "samarium", units="ppm", coerce=ingest_utils.get_clean_number),
            fld("samarium_meth", "samarium_meth"),
            fld("samp_size", "samp_size", units="liter", coerce=ingest_utils.get_clean_number),
            fld("samp_vol_we_dna_ext", "samp_vol_we_dna_ext", units="liter", coerce=ingest_utils.get_clean_number),
            ...
            fld("scandium", "scandium", units="ppm", coerce=ingest_utils.get_clean_number),
            ...
            fld("sediment_grain_size", "sediment_grain_size", units="ppm", coerce=ingest_utils.get_clean_number),
            fld("sediment_grain_size_meth", "sediment_grain_size_meth"),
            fld("sediment_grain_size_fract", "sediment_grain_size_fract", units="ppm", coerce=ingest_utils.get_clean_number),
            ...
            fld("selenium", "selenium",  units=u"\u00B5" + "g/kg",
                coerce=ingest_utils.get_clean_number,),
            fld("selenium_meth", "selenium_meth"),
            fld("shoot_length", "shoot_length",  units="cm",
                coerce=ingest_utils.get_clean_number,),
            ...
            fld("sodium", "sodium",  units="mg/l",
                coerce=ingest_utils.get_clean_number,),
            fld("sodium_meth", "sodium_meth"),
            fld("specific_host", "specific_host"),
            fld("stress", "stress"),
            fld("strontium", "strontium",   units="ppm",
                coerce=ingest_utils.get_clean_number,),
            ...
            fld("synecochoccus", "synecochoccus",  units="cells/ml",
                coerce=ingest_utils.get_clean_number,),
            fld("synecochoccus_meth", "synecochoccus_meth"),
            fld("tantalum", "tantalum",  units="ppm",
                coerce=ingest_utils.get_clean_number,),
            ...
            fld("terbium", "terbium",  units="ppm",
                coerce=ingest_utils.get_clean_number,),
            fld("terbium_meth", "terbium_meth"),
            fld("texture", "texture"),
            fld("texture_meth", "texture_meth"),
            fld("thorium", "thorium", units="ppm", coerce=ingest_utils.get_clean_number),
            fld("thorium_meth", "thorium_meth"),
            fld("thulium", "thulium", units="ppm", coerce=ingest_utils.get_clean_number),
            ...
            fld("tot_depth_water_col", "tot_depth_water_col", units="m", coerce=ingest_utils.get_clean_number),
            fld("tot_depth_water_meth", "tot_depth_water_meth"),
            fld("tot_nitro", "tot_nitro", units="%", coerce=ingest_utils.get_clean_number),
            fld("tot_n_meth", "tot_n_meth"),
            fld("tot_org_carb", "tot_org_carb", units="%", coerce=ingest_utils.get_clean_number),
            fld("tot_org_c_meth", "tot_org_c_meth"),
            fld("tot_phosp", "tot_phosp", units="%", coerce=ingest_utils.get_clean_number),
            ...
            fld("total_nitrogen", "total_nitrogen", units="mg/kg", coerce=ingest_utils.get_clean_number),
            ...
            fld("tungsten", "tungsten", units="ppm", coerce=ingest_utils.get_clean_number),
            ...
            fld("uranium", "uranium", units="ppm", coerce=ingest_utils.get_clean_number),
            fld("uranium_meth", "uranium_meth"),
            fld("url", "url"),
            fld("vanadium", "vanadium", units="ppm", coerce=ingest_utils.get_clean_number),
            ...
            fld("water_content", "water_content", units="%", coerce=ingest_utils.get_clean_number),
            fld("water_content_soil_meth", "water_content_soil_meth"),
            fld("water_holding_capacity", "water_holding_capacity", units="g/cm3", coerce=ingest_utils.get_clean_number),
            fld("water_holding_capacity_meth", "water_holding_capacity_meth"),
            fld("ytterbium", "ytterbium", units="ppm", coerce=ingest_utils.get_clean_number),
            fld("ytterbium_meth", "ytterbium_meth"),
            fld("yttrium", "yttrium", units="ppm", coerce=ingest_utils.get_clean_number),
            fld("yttrium_meth", "yttrium_meth"),
            fld("zea", "zea", units="mg/m3", coerce=ingest_utils.get_clean_number,),
            fld("zea_meth", "zea_meth"),
            fld("zirconium", "zirconium", units="ppm", coerce=ingest_utils.get_clean_number),
            fld("zirconium_meth", "zirconium_meth"),
            fld("zooplankton_biomass", "zooplankton_biomass", units="mg/m3", coerce=ingest_utils.get_clean_number),
