...
class AustralianMicrobiomeSampleContextual:
    ...
    field_specs = {
        sheet_name: [
            ...
            fld(
                "ammonium",
                "ammonium_μmol_per_l".encode('utf-8'),
                units="µmol/l".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            fld("ammonium_μmol_per_l_method".encode('utf-8'), "ammonium_μmol_per_l_method".encode('utf-8')),
            fld(
                "anth",
                "anth_mg_per_m3",
                units="mg/m3",
            ...
            fld(
                "arsenic",
                "arsenic_µg_per_kg".encode('utf-8'),
                units="µg/kg".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                "cadmium",
                "cadmium_µg_per_kg".encode('utf-8'),
                units="µg/kg".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                "chlorophyll_a",
                "chlorophyll_a_μg_per_l".encode('utf-8'),
                units="µg/l".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                "chromium",
                "chromium_µg_per_kg".encode('utf-8'),
                units="µg/kg".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                "light_intensity_meadow_µmol_per".encode('utf-8'),
                "light_intensity_meadow_µmol_per_m2_per_s1".encode('utf-8'),
                units="m2/s1",
                coerce=ingest_utils.get_clean_number,
            ),
            fld("light_intensity_meadow_method", "light_intensity_meadow_method"),
            fld(
                "light_intensity_µmol_m2_s1_bottom".encode('utf-8'), "light_intensity_µmol_m2_s1_bottom".encode('utf-8')
            ),
            fld("light_intensity_bottom_method", "light_intensity_bottom_method"),
            fld(
                "light_intensity_µmol_m2_s1_surface".encode('utf-8'),
                "light_intensity_µmol_m2_s1_surface".encode('utf-8'),
            ),
            ...
            fld(
                "nitrate_nitrite",
                "nitrate_nitrite_μmol_per_l".encode('utf-8'),
                units="µmol/l".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                "nitrite",
                "nitrite_μmol_per_l".encode('utf-8'),
                units="µmol/l".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                "oxygen_ctd",
                "oxygen_μmol_per_kg_ctd".encode('utf-8'),
                units="µmol_per_kg".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            fld("oxygen_μmol_per_kg_ctd_method".encode('utf-8'), "oxygen_μmol_per_kg_ctd_methods".encode('utf-8')),
            fld(
                "oxygen",
                "oxygen_μmol_per_l".encode('utf-8'),
                units="µmol/l".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            fld("oxygen_μmol_per_l_method".encode('utf-8'), "oxygen_μmol_per_l_method".encode('utf-8')),
            ...
            fld(
                "phosphate",
                "phosphate_μmol_per_l".encode('utf-8'),
                units="µmol/l".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                ...
                "sediment_porewater_h4sio4_μmol_per_l".encode('utf-8'),
                units="µmol/l".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                ...
                "sediment_porewater_nh4_μmol_per_l".encode('utf-8'),
                units="µmol/l".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                ...
                "sediment_porewater_no2_μmol_per_l".encode('utf-8'),
                units="µmol/l".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                ...
                "sediment_porewater_no3_μmol_per_l".encode('utf-8'),
                units="µmol/l".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                ...
                "sediment_porewater_po43_μmol_per_l".encode('utf-8'),
                units="µmol/l".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                "silicate",
                "silicate_μmol_per_l".encode('utf-8'),
                units="µmol/l".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                "total_alkalinity",
                "total_alkalinity_μmol_per_kg".encode('utf-8'),
                units="µmol/kg".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                "total_co2",
                "total_co2_μmol_per_kg".encode('utf-8'),
                units="µmol/kg".encode('utf-8'),
                coerce=ingest_utils.get_clean_number,
            ),
