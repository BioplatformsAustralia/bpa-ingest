...
class AustralianMicrobiomeSampleContextual:
    metadata_urls = [
        "https://downloads-qcif.bioplatforms.com/bpa/amd/metadata/contextual/2023-12-12/"
    ]
    ...
    field_specs = {
        sheet_name: [
            ...
            fld("grazing_number",
                ...
                coerce=ingest_utils.get_clean_number),
            fld("grazing", "grazing", units="%", coerce=ingest_utils.get_percentage,),
            ...
            fld(
                "tot_carb", "tot_carb", units="%", coerce=ingest_utils.get_percentage,
            ),
