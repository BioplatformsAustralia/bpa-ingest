...
class AustralianMicrobiomeSampleContextual:
    ...
    field_specs = {
        sheet_name: [
            ...
            fld(
                "ammonium",
                "ammonium_" + u"\u00B5" + "mol_per_l",
                units=u"\u00B5" + "mol/l",
                coerce=ingest_utils.get_clean_number,
            ),
            fld(
                "ammonium_method",
                "ammonium_" + u"\u00B5" + "mol_per_l_method",
                units=u"\u00B5" + "mol_per_l",
            ),
            fld(
                "anth",
            ...
            fld(
                ...
                "light_intensity_meadow_" + u"\u00B5" + "mol_per_m2_per_s1",
            ...
            fld(
                "nitrate_nitrite",
                "nitrate_nitrite_" + u"\u00B5" + "mol_per_l",
                units=u"\u00B5" + "mol/l",
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                "oxygen_ctd",
                "oxygen_" + u"\u00B5" + "mol_per_kg_ctd",
                units=u"\u00B5" + "mol_per_kg",
                coerce=ingest_utils.get_clean_number,
            ),
            fld(
                "oxygen_ctd_method",
                "oxygen_" + u"\u00B5" + "mol_per_kg_ctd_method",
                units=u"\u00B5" + "mol_per_kg",
            ),
            fld(
                "oxygen",
                "oxygen_" + u"\u00B5" + "mol_per_l",
                units=u"\u00B5" + "mol/l",
                coerce=ingest_utils.get_clean_number,
            ),
            fld(
                "oxygen_method",
                "oxygen_" + u"\u00B5" + "mol_per_l_method",
                units=u"\u00B5" + "mol_per_l",
            ),
            ...
            fld(
                ...
                "sediment_porewater_h4sio4_" + u"\u00B5" + "mol_per_l",
                units=u"\u00B5" + "mol/l",
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                ...
                "sediment_porewater_nh4_" + u"\u00B5" + "mol_per_l",
                units=u"\u00B5" + "mol/l",
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                ...
                "sediment_porewater_no2_" + u"\u00B5" + "mol_per_l",
                units=u"\u00B5" + "mol/l",
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                ...
                "sediment_porewater_no3_" + u"\u00B5" + "mol_per_l",
                units=u"\u00B5" + "mol/l",
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                ...
                "sediment_porewater_po43_" + u"\u00B5" + "mol_per_l",
                units=u"\u00B5" + "mol/l",
                coerce=ingest_utils.get_clean_number,
            ),
            ...
            fld(
                "total_alkalinity",
                "total_alkalinity_" + u"\u00B5" + "mol_per_kg",
                units=u"\u00B5" + "mol/kg",
                coerce=ingest_utils.get_clean_number,
            ),
