...
class WorkshopPlantPathogenDatasetControlContextual(BaseDatasetControlContextual):
    metadata_urls = [
...
class WorkshopPlantPathogenLibraryContextual(BaseLibraryContextual):
    metadata_urls = [
...
class WorkshopFungiDatasetControlContextual(BaseDatasetControlContextual):
    metadata_urls = [
...
class WorkshopFungiLibraryContextual(BaseLibraryContextual):
    metadata_urls = [
