...
class PlantProteinAtlasMetabolomicsAnalysedMetadata(PlantProteinAtlasBaseMetadata):
        ...
        spreadsheet = {
            "fields": [
                ...
                fld("facility_sample_id", "facility_sample_id"),
                fld('metabolomics_facility', 'metabolomics_facility'),
                fld('analytical_platform', 'analytical_platform', optional=True),
                fld('sample_fractionation_extraction_solvent', 'sample_fractionation_/_extraction_solvent', optional=True),
                fld('mobile_phase_composition', 'mobile_phase_composition', optional=True),
                fld('lc_column_type', 'lc_column_type', optional=True),
                fld('gradient_time', 'gradient_time_(min)_/_flow', optional=True),
                fld('mass_spectrometer', 'mass_spectrometer', optional=True),
                fld('acquisition_mode', 'acquisition_mode', optional=True),
                fld('activation_type', 'activation_type', optional=True),
                fld('analysis_type', 'analysis_type', optional=True),
                fld('nmr_probe_type', 'nmr_probe type', optional=True),
                fld('nmr_nucleus', 'nmr_nucleus', optional=True),
                fld('nmr_pulse_sequence', 'nmr_pulse sequence', optional=True),
                fld('contact_person', 'contact_person', optional=True),
...
class PlantProteinAtlasProteomicsMetadata(PlantProteinAtlasBaseMetadata):
    ...
    spreadsheet = {
        "fields": [
            ...
            fld("planting_season", "planting_season", optional=True),
            fld("planting_site", "planting_site", optional=True),
            fld("planting_code", "planting_code", optional=True),
            fld("planting_block", "planting_block", optional=True),
            fld("planting_row", "planting_row", optional=True),
            fld("planting_bay", "planting_bay", optional=True),
            fld("variety_commercial", "variety_commercial", optional=True),
            fld("variety_name", "variety_name", optional=True),
            fld("plant_replicate", "plant_replicate", optional=True),
            fld("data_type", "data_type"),
            fld("omics", "omics"),
            fld("data_context", "data_context"),
            fld("facility_project_code", "facility_project_code"),
            ...
            fld('analytical_platform', 'analytical_platform'),
            fld('sample_fractionation', 'sample_fractionation_(none/number)', optional=True),
            ...
            fld('file_description', 'file_description'),
            fld("sample_fractionation_replicate", "sample_fractionation_replicate_#", optional=True),
            fld("sample_fractionation_protein_name", "sample_fractionation_protein_name", optional=True),
    ...
    md5 = {
        "match": [
            ...
            files.proteomics_sample_filename_2_re,
            files.xlsx_filename_re,
        ],
        "skip": [
            re.compile(r"^.*SampleSheet.*"),
...
class PlantProteinAtlasProteomicsAnalysedMetadata(PlantProteinAtlasBaseMetadata):
        ...
        spreadsheet = {
            "fields": [
                ...
                skp('proteome_size'),
                skp('sample_fractionation_(none/number)'),
                skp("sample_fractionation_replicate_#"),
                skp("sample_fractionation_protein_name"),
                skp('albumin_(%_of_total_protein)'),
                skp('globulin_(%_of_total_protein)'),
                skp('prolamin_(%_of_total_protein)'),
                skp('glutelin_(%_of_total_protein)'),
                skp('residual_(%_of_total_protein)'),
            ],
            "options": {
                "sheet_name": "Library metadata",
                "header_length": 1,
