...
class PlantProteinAtlasLibraryContextual(BaseLibraryContextual):
    ...
    field_spec = [
            ...
            fld('decimal_latitude_private', 'decimal_latitude_private', coerce=ingest_utils.get_clean_number),
            fld('decimal_longitude_private', 'decimal_longitude_private', coerce=ingest_utils.get_clean_number),
            fld('coord_uncertainty_metres', 'coord_uncertainty_metres', coerce=ingest_utils.get_clean_number),
