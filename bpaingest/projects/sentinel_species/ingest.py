...
from . import files
from .contextual import SentinelSpeciesLibraryContextual, SentinelSpeciesDatasetControlContextual
from .tracking import SentinelSpeciesGoogleTrackMetadata
...
common_context = [SentinelSpeciesLibraryContextual, SentinelSpeciesDatasetControlContextual]

CONSORTIUM_ORG_NAME = "sentinel-species-consortium-members"


class SentinelSpeciesBaseMetadata(BaseMetadata):
    initiative = "Sentinel Species"
    organization = "sentinel-species"
    generaliser = None
    ...
    def __init__(self, logger, metadata_path, contextual_metadata=None, metadata_info=None):
        ...
        self.google_track_meta = SentinelSpeciesGoogleTrackMetadata(logger)
...
class SentinelSpeciesIlluminaShortreadMetadata(SentinelSpeciesBaseMetadata):
    ckan_data_type = "sens-illumina-shortread"
    ...
    metadata_urls = [
        "https://downloads-qcif.bioplatforms.com/bpa/sentinel_species/illumina-shortread/",
    ]
...
class SentinelSpeciesONTPromethionMetadata(SentinelSpeciesBaseMetadata):
        ckan_data_type = "sens-ont-promethion"
        ...
        metadata_patterns = [r"^.*\.md5$", r"^.*_metadata.*.*\.xlsx$"]
        metadata_urls = [
            "https://downloads-qcif.bioplatforms.com/bpa/sentinel_species/ont-promethion/",
        ]
        metadata_url_components = ("ticket",)
...
class SentinelSpeciesPacbioHifiMetadata(SentinelSpeciesBaseMetadata):
    ckan_data_type = "sens-pacbio-hifi"
    ...
    metadata_urls = [
        "https://downloads-qcif.bioplatforms.com/bpa/sentinel_species/pacbio-hifi/",
    ]
    metadata_url_components = ("ticket",)
    resource_linkage = ("bioplatforms_library_id", "flowcell_id")
    spreadsheet = {
